...
import pandas as pd
from newRuleBased import hitung_AKEi_umur, rekomendasi_makanan, dataset
...
def get_rekomendasi():
    ...
    for meal_id in [1, 2, 3]:  # diasumsikan 1: sarapan, 2: makan siang, 3: makan malam
        ...
        filtered_recipes = hasil_rekomendasi[hasil_rekomendasi['mealtimeId'] == meal_id][['Recipe ID']]
